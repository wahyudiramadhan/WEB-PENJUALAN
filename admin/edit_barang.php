		...
		<form method="post" action="update_barang.php">
			<table>
                ...
                <tr>
                        ...
                        <td>
                        <select name="id_kat">
                        <option><?php echo $d['id_kat']; ?></option>
                        <?php
				...
				<tr>
					<td>HARGA BARANG :</td>
					<td><input type="text" name="harga_barang" value="<?php echo $d['harga_barang']; ?>"></td>
				</tr>
				<tr>
					<td></td>
					<td><input type="submit" name="update" class="btn btn-success" value="SIMPAN"></td>
				</tr>		
			</table>
		</form>
		<?php 
