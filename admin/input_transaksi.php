        ...
        <div class="row" id="body-row">
            ...
            <div class="col">
                ...
                <div class="form-group col-18" >
                    ...
                    <i>TAMBAH transaksi</i>
                    </div>
                    <form action="input_transaksi_proses.php" method="post">
                    <table>
                    ...
                    <tr>
                        <td><input type="submit" name="tambah_transaksi" class="btn btn-success"value="SIMPAN"></td>
                    </tr>	   
                    </table>
                    </form>
                    </div>
